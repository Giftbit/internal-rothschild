...
# UPDATE rothschild.`Values`
# SET balance       = usesRemaining * genericCodeOptions_perCotact_balance,
#     usesRemaining = NULL
# WHERE isGenericCode = TRUE
#   AND usesRemaining IS NOT NULL
#   AND balance IS NOT NULL
#   AND genericCodeOptions_perContact_usesRemaining IS NULL
#   AND genericCodeOptions_perCotact_balance IS NOT NULL; -- this column will have been populated by the earlier query.
#
