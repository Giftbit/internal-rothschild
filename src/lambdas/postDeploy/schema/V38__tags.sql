...
(
    ...
    createdBy   VARCHAR(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
...
(
    userId        VARCHAR(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    transactionId VARCHAR(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    tagId         VARCHAR(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
...
ALTER TABLE rothschild.ValueTags
    ...
    DROP COLUMN tag,
    ADD COLUMN tagId VARCHAR(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
