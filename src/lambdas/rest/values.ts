...
function checkProgramConstraints(value: Value, program: Program): void {
    ...
    if (program.minInitialBalance && (value.balance < program.minInitialBalance || value.balance === null)) {
    ...
    if (program.maxInitialBalance && (value.balance > program.maxInitialBalance || value.balance === null)) {
